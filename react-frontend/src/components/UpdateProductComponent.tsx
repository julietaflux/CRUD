...
export const UpdateProductComponent = (props: any) => {
    ...
    const updateProduct = (e: any) => {
        if (!product) return;
        e.preventDefault();
        let p = {Id: product.id, Name: product.name, Brand: product.brand, Cost: Number(product.cost), Price: Number(product.price)};
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className={"btn btn-sm " + (validPrice ? 'btn-primary' : 'disabled')} onClick={updateProduct} disabled={!validPrice}>Save</button>
